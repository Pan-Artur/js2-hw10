...
const timerOfInterval = ()=>{
    ...
    const modalClose = (e)=>{
        if (e.target.classList.contains("modal-yes") || e.target.classList.contains("modal-no")) {
            overlayEl.classList.add("hidden");
            coupleEl.removeEventListener("click", modalClose);
            count += 1;
            if (count < 5) setTimeout(startInterval, 1000);
        }
    };
    const startInterval = ()=>{
        setTimeout(()=>{
    ...
    function startTimer() {
        ...
        const interval = setInterval(()=>{
            ...
            if (timer === 0) {
                ...
                pointsEl.textContent = `\u{417}\u{430}\u{440}\u{43E}\u{431}\u{43B}\u{435}\u{43D}\u{43E}: ${totalPoints} $ITCOIN`;
                resultEl.textContent = `\u{412}\u{438} \u{437}\u{430}\u{440}\u{43E}\u{431}\u{438}\u{43B}\u{438} ${roundPoints} $ITCOIN, \u{443}\u{441}\u{44C}\u{43E}\u{433}\u{43E} \u{43B}\u{438}\u{448}\u{435} \u{437}\u{430} ${initialTimer} \u{441}\u{435}\u{43A}\u{443}\u{43D}\u{434}`;
                overlayEl.classList.remove("hidden");
            }
        }, 1000);
    }
...
startButton.addEventListener("click", ()=>{
    ...
    message.textContent = `\u{41E}\u{447}\u{456}\u{43A}\u{443}\u{439}\u{442}\u{435} ${time} \u{441}\u{435}\u{43A}\u{443}\u{43D}\u{434}...`;
    setTimeout(()=>{
